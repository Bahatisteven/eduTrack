...
1. **Open in browser:** Load `calculator.html`
2. **Check console:** Press F12 → Console tab → No errors should appear
3. **Average display:** Verify the % shows correctly (e.g., "82.5%")
4. **GPA display:** Check format is X.X (e.g., "3.2")
5. **Grade letter:** Should show A, B, C, D, or F
6. **Total credits:** Should show the sum of all subject credits
7. **Progress bar:** Watch it smoothly fill on page load
